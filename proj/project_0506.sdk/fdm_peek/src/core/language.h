...
#ifndef SRC_CORE_LANGUAGE_H_
#define SRC_CORE_LANGUAGE_H_

#include "../fdm_config.h"//"../MarlinConfig.h"
...
// 如果在configuretion.h中已经定义了LCD_LANGUAGE的话,那么此处就可以跳过
#ifndef LCD_LANGUAGE
...
// 3条语句完成对language有文件的调用,如language_zh_CN.h
